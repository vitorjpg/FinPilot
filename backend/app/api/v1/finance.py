...
async def get_balance(db: Session = Depends(get_db), email: str = Depends(get_current_user_email)):
    ...
    return {"total_receita": receitas, "total_despesa": despesas, "saldo": receitas - despesas}
...
# ROTA DE EXCLUSÃO (Mata dois coelhos: deleta despesa e permite trocar salário)
